        ...
        <table>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text"  name="price" required="" lay-verify="required"
                               autocomplete="off" class="layui-input" value="${food.price}">
                    </div>
                </div>
            </tr>
            <tr>
            ...
            <tr>
                <div >
                    ...
                    <input   type="file" name="upload" size="30"  required="" value="${food.imgurl}"/>
                    原图片<img src="${food.imgurl}" width="40" href="40">
                </div>
            </tr>
            <tr>
            ...
            <tr>
                <div class="layui-form-item">
                    ...
                    <button  class="layui-btn" lay-filter="add" lay-submit="" >
                        <a href="${pageContext.request.contextPath}/foodEdit?id=${food.id}">确定</a>
                    </button>
                </div>
            </tr>
        </table>
