...
<head>
	...
	<script>
		function add(){
			var txt=document.getElementByName("txt");
			var a=txt.value;
			a++;
			txt.value=a;
		}
	...
	<section id="single-product">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="block">
						<form  name="" action="${pageContext.request.contextPath}/buyFood" method="post" >
						<div class="product-des">
							...
							<input  name="amount" id="amount" value="1" size="5">
							<input type=button value="+" onClick="javascript:this.form.amount.value++;">
							<script>
								function hello() {
									var amount =$("#amount").val();
									console.log(amount)
									window.location.href="${pageContext.request.contextPath}/buyFood?id=${food.id}\n&stuId=${sessionScope.user.id}&amount="+amount;
								}
							</script>
							<a class="view-link" onclick="hello()">加入购物车</a>
