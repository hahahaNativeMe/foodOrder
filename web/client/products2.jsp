...
<section id="top">
		...
		<div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav nav-main">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/showShop?cate=荤菜">商店</a></li>
	...
	<section id="shop">
		<div class="container">
			<form action="${pageContext.request.contextPath}/showShop" name="shop" method="post" enctype="multipart/form-data">
					...
					<div class="col-md-9">
						...
						<div class="pagination-bottom">
							<ul class="pagination">
								...
								<li><a href="sortProduct?page=1&cate=${category}">首页</a></li>
								<li><a href="sortProduct?page=${page-1}&cate=${category}">上一页</a></li>
								<li><a href="sortProduct?page=${page+1}&cate=${category}">下一页</a></li>
								<li><a href="sortProduct?page=${pageNum}&cate=${category}">尾页</a></li>
